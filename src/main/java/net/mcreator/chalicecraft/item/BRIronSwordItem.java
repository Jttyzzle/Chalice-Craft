...
public class BRIronSwordItem extends ChaliceCraftElements.ModElement {
	@ObjectHolder("chalicecraft:brironsword")
	public static final Item block = null;
	public BRIronSwordItem(ChaliceCraftElements instance) {
		super(instance, 6);
	}
