...
public class BRStoneSwordItem extends ChaliceCraftElements.ModElement {
	@ObjectHolder("chalicecraft:brstonesword")
	public static final Item block = null;
	public BRStoneSwordItem(ChaliceCraftElements instance) {
		super(instance, 11);
	}
