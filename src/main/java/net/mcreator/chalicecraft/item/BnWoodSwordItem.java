...
public class BnWoodSwordItem extends ChaliceCraftElements.ModElement {
	@ObjectHolder("chalicecraft:bnwoodsword")
	public static final Item block = null;
	public BnWoodSwordItem(ChaliceCraftElements instance) {
		super(instance, 10);
	}
