...
public class BRWoodSwordItem extends ChaliceCraftElements.ModElement {
	@ObjectHolder("chalicecraft:brwoodsword")
	public static final Item block = null;
	public BRWoodSwordItem(ChaliceCraftElements instance) {
		super(instance, 13);
	}
