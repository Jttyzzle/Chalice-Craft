...
public class BnIronSwordItem extends ChaliceCraftElements.ModElement {
	@ObjectHolder("chalicecraft:bnironsword")
	public static final Item block = null;
	public BnIronSwordItem(ChaliceCraftElements instance) {
		super(instance, 7);
	}
